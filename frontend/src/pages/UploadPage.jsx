      ...
      <div className="flex min-h-screen items-center justify-center bg-gray-100 px-4">
        <div className="w-full max-w-md rounded-lg bg-white p-8 text-center shadow">
          ...
          <p className="text-gray-700">
            This tool must be opened directly from the assignment in Moodle. Please go back to Moodle and open the
            tool from there.
          </p>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-gray-100 px-4 py-10">
      <div className="mx-auto max-w-[600px] rounded-lg bg-white p-6 shadow">
        <div className="mb-6 rounded-md border border-amber-300 bg-amber-50 p-4 text-sm text-amber-900">
          This tool can only be used once per assignment, and it is intended for review and guidance only — it does
          not give grades or write any part of the assignment on your behalf.
        </div>

        <h1 className="mb-6 text-center text-2xl font-bold text-gray-900">Pre-Submission Assignment Review</h1>

        <div className="mb-6">
          <FileDropzone
            label="Assignment file (required)"
            required
            accept=".docx,.pdf"
